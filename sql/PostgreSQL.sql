...
INSERT INTO "users" VALUES (1, 'admin@email.local', '$2y$10$SmgtipaB23/HayIAUQyEGeuZjTRLpA38PpAMIiw65kVtjcHgO3r6C', 'Admin', 0, 1, 1, 1, 1637790896, NULL, 0) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO "users_confirmations" VALUES (1, 1, 'admin@email.local', 'gT2JRjmAVGqP275w', '$2y$10$BMzLzZPFBfc01issfunbO.pceOWDcl4hd8BuWAlPDMEMdLEtRx.BC', 1637877297) ON CONFLICT (id) DO NOTHING;
